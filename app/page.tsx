            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-primary/50 transition-all duration-300">
                  ...
                  <span className="text-muted-foreground">Étudiant en 4e année à l'Institut Saint Jean du Cameroun</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-primary/50 transition-all duration-300">
                  <div className="p-2 bg-primary/10 rounded-lg">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Button asChild variant="outline" size="lg" className="hover:bg-primary/10 hover:border-primary/50 transition-all duration-300">
