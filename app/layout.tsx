...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio de Réné Alban KOMTSINDI, élève ingénieur en 5e année (2026–2027). Software Engineering et Data Engineering. MicroRecouv, lakehouse hybride (ADLS / Event Hubs), AquaSensus.",
  generator: "v0.app",
}
